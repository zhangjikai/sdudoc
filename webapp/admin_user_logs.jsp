								...
								<table >
									...
									<tr>
										<td colspan="4">
											...
											<a href='admin/listUserLogs?logPageNo=<s:property value="logPager.firstPageNo"/>&selectedUserId=<s:property value="selectedUserId"/>'>首页</a> 
											<a href='admin/listUserLogs?logPageNo=<s:property value="logPager.prePageNo"/>&selectedUserId=<s:property value="selectedUserId"/>'>上一页</a>
											<a href='admin/listUserLogs?logPageNo=<s:property value="logPager.nextPageNo"/>&selectedUserId=<s:property value="selectedUserId"/>'>下一页</a>
											<a href='admin/listUserLogs?logPageNo=<s:property value="logPager.lastPageNo"/>&selectedUserId=<s:property value="selectedUserId"/>'>尾页</a>
										</td>
									</tr>
								</table>
							</div>
