				...
				<div id="holder" >
					<div id="menu">
						...
						<ul>
							...
							<li>
								<a href="user/userLog" class="selected">
									<span>近期操作</span>
								</a>
							</li>
							<li>
								...
								<table >
									...
									<tr>
										<td colspan="2">
											...
											<a href='user/userLog?logPageNo=<s:property value="logPager.firstPageNo"/>'>首页</a> 
											<a href='user/userLog?logPageNo=<s:property value="logPager.prePageNo"/>'>上一页</a>
											<a href='user/userLog?logPageNo=<s:property value="logPager.nextPageNo"/>'>下一页</a>
											<a href='user/userLog?logPageNo=<s:property value="logPager.lastPageNo"/>'>尾页</a>
										</td>
									</tr>
								</table>
							</div>
